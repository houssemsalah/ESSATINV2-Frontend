...
@Component({
  selector: 'app-liste-des-classes',
  templateUrl: './liste-des-classes.component.html',
  styleUrls: ['./liste-des-classes.component.css']
})
export class ListeDesClassesComponent implements OnInit {
